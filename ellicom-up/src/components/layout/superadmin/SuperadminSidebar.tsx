...
const navItems = [
  ...
  { label: "Users", icon: Users, href: "/superadmin/users" }, // Superadmin manages users
  { label: "Jobs", icon: Briefcase, href: "/superadmin/jobs" },
  { label: "Invoices", icon: FileText, href: "/superadmin/invoices" },
  { label: "Stocks", icon: Boxes, href: "/superadmin/stocks" },
  { label: "Team", icon: UserCog, href: "/superadmin/team" },
  { label: "Pricing", icon: Tag, href: "/superadmin/pricing" },
  { label: "Add Job", icon: PlusCircle, href: "/superadmin/addJob" },
